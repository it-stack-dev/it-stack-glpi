# Lab 17-05 — Advanced Integration

**Module:** 17 — GLPI IT service management and CMDB  
**Duration:** See [lab manual](https://github.com/it-stack-dev/it-stack-docs)  
**Test Script:** 	ests/labs/test-lab-17-05.sh  
**Compose File:** docker/docker-compose.integration.yml

## Objective

Connect glpi to the full IT-Stack ecosystem (FreeIPA, Traefik, Graylog, Zabbix).

## Prerequisites

- Labs 17-01 through 17-04 pass
